...
description: How the same AI technology can empower humans—or take control—depending on where authority sits. Values matter.
---
...
{/* Embedded SVG (place file at: public/images/ai/ai liberation vs domination.svg) */}
![AI: Liberation vs Domination — diagram](/images/ai/ai liberation vs domination.svg)
